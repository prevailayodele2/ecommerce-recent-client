...
const login = (email, password) => async(dispatch) => {
    try {
        ...
        const {data} = await axios.post('https://east-api-clothing.onrender.com/api/users/login', {email, password}, config)
        dispatch({
...
export const getUserDetails = (id) => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.get(`https://east-api-clothing.onrender.com/api/users/${id}`, config)
        dispatch({
...
export const updateUserProfile = (user) => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.put(`https://east-api-clothing.onrender.com/api/users/profile`, user, config)
        dispatch({
...
export const ListUsers = () => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.get(`https://east-api-clothing.onrender.com/api/users`, config)
        dispatch({
...
export const DeleteUser = (id) => async(dispatch, getState) => {
    try {
        ...
        await axios.delete(`https://east-api-clothing.onrender.com/api/users/${id}`, config)
        dispatch({
...
export const updateUser = (user) => async(dispatch, getState) => {
    try {
        ...
        const {data} =  await axios.put(`https://east-api-clothing.onrender.com/api/users/${user._id}`,user, config)
        dispatch({
